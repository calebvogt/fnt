...
load('B:\Data\mPFC-VTA Photometry\Robot OFT\Processed Photometry Data\886_20190228_proc1.mat'); % CHANGE PER MOUSE
% Calculate dF/F
...
ttl= round(dordata_proc.ttl1(:,1),2); % round to nearest Doric timestamp (.01)
...
aviobj = VideoWriter(fullfile(fp,'886combined')); % CHANGE PER MOUSE
aviobj.FrameRate=30;
open(aviobj);
